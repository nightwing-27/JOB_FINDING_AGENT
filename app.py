...
def ask_gemini_intent(prompt):
    ...
    url = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-3-pro:generateContent?key={GEMINI_API_KEY}"
    system_instruction = """
...
def playwright_scrape_and_parse(url, company):
    ...
    # ⚡ UPDATED: Pointing to Gemini 3 Flash Live
    ai_url = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-3-pro:generateContent?key={GEMINI_API_KEY}"
